...
<link href="https://fonts.googleapis.com/css2?family=DM+Serif+Display:ital@0;1&family=Permanent+Marker&family=Righteous&family=Roboto&display=swap" rel="stylesheet">
    ...
    <body>    
        <header class="header">
          <a href="/"><h3 class="title">MIRU KIM</h3></a>
          <br>
          <nav id="navbar" href="#">
            <div class="dropdown">
            ...
            <div class="dropdown">
              ...
              <div style="text-align:left; width:20%;"><a class="contactmenu" href="/contact">CONTACT</a>              
              </div>
              <a href="https://instagram.com/miru_studio"><i style="margin-left:70px;" class="fa-brands fa-instagram fa-lg"></i></a>
...
${shortdes}
    ...
    var i = 0;
    while(i < imgList.length){
      list = list + `<div><img id="imgSlide${i+1}" class="slide1" src="/slideimg/${imgList[i]}" style="width:1000px; height:666px;"></div>\n`;
      i = i+1;
    }    
    return list;
    ...
    var i = 0;
    while(i < imgList.length){
      list = list + `<div><img id="imgSlide${i+1}" class="slide1" src="/artwork/${id}/images/${imgList[i]}" style="width:1000px; height:666px;"></div>\n`;
      i = i+1;
    }
    return list;
        ...
        <header class="header">
          ...
          <nav id="navbar" href="#">
            ...
            <div class="dropdown">
              ...
              <div style="text-align:center; width:20%;"><a class="contactmenu" href="/contact">CONTACT</a>              
              </div>
              <a href="https://instagram.com/miru_studio"><i style="margin-left:70px;" class="fa-brands fa-instagram fa-lg"></i></a>
    ...
    <body>
      ...
      <br><br>
        <div class="image">      
          ...
          <h5 style="display:block; margin-left:65px">${pageTitle}</h5>
          <pre style="display:block; margin-left:65px">
${pageDescription}
          </pre>
        </div>
